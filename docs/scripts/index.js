document.addEventListener('DOMContentLoaded', function () {
  ...
  const baseNodes = [
    ...
    { id: 'ca', label: 'CA', group: 'level3', x: -470, y: -20, image: 'images/icons/ca.png' },
    { id: 'se', label: 'SE', group: 'level3', x: -360, y: 80, image: 'images/icons/se.png' },
    { id: 'net', label: 'Net & Sec', group: 'level3', x: -560, y: 160, image: 'images/icons/netsec.png' },
    { id: 'ai', label: 'AI & Data', group: 'level3', x: -460, y: 220, image: 'images/icons/ai.png' },
